...
import tests.jBehave.steps.radioButtonSteps.RadioButtonSteps;


public class RadioButtonMapper extends JUnitStories{
	...
	protected List<String> storyPaths() {
		return Arrays.asList("tests/jBehave/stories/SingleRadioButton.story");
